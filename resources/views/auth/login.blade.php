<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        {{-- ── Back to Home ── --}}
        {{-- Allows guests to return to the welcome page without logging in --}}
        <a href="{{ route('home') }}"
           class="block text-center text-sm text-gray-400 hover:text-gray-600 mt-4 transition-colors duration-200">
            ← Back to Home
        </a>
